...
@Extension(bizId = BizCode.PERSONAL_BANKING_BUSINESS, useCase = UseCaseCode.ACCOUNT_TRANSFER, scenario = ScenarioCode.SEND_SHORT_MESSAGE)
public class AccountTransferSucceedSendMessageExt implements SendMessageExtPt {
