...
@Extension(bizId = BizCode.PERSONAL_BANKING_BUSINESS, useCase = UseCaseCode.ACCOUNT_DEPOSIT, scenario = ScenarioCode.SEND_SHORT_MESSAGE)
public class AccountDepositSucceedSendMessageExt implements SendMessageExtPt {
